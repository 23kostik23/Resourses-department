...
namespace відділ_кадрів_WF
{
    public partial class HireForm : Form
    {
        ...
        public HireForm(ResouresDepartament resouresDepartament)
        {
            InitializeComponent();
        ...
        public void OkButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (workerAge <= -18) workerAge *= -1;
                else if (workerAge > -18 && workerAge < 18) workerAge = 18;
            ...
            _resouresDepartament.AddWorker(worker);
